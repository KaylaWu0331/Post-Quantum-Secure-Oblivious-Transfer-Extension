...
void PQOTraw::send_ot(mpz_t* m_0, mpz_t* m_1, int num_ot, int bitlen, bool verify_ot){
...
void PQOTraw::recv_ot(mpz_t* m_b, bool* b, int num_ot, int bitlen, bool verify_ot){
    // Start the IO threads
    send->start();
    recv->start();
...
bool PQOTraw::verify(mpz_t* m_0, mpz_t* m_1, int num_ot){
...
bool PQOTraw::verify(mpz_t* m_b, bool* b, int num_ot){
